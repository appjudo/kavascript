# The KavaScript parser is generated by [Jison](http://github.com/zaach/jison)
...
#
# If you run the `kake build:parser` command, Jison constructs a parse table
...
grammar =
  ...
  # KavaScript is the **Expression** -- everything that can be an expression
  ...
  # KavaScript has two different symbols for functions. `->` is for ordinary
  ...
  # In KavaScript, an object literal is simply a list of assignments.
  Object: [
  ...
  Operation: [
    ...
    # [The existential operator](http://jashkenas.github.com/kavascript/#existence).
