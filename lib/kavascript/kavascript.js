...
(function() {
  ...
  exports.compile = compile = withPrettyErrors(function(code, options) {
    ...
    if (options.header) {
      header = "Generated by KavaScript " + this.VERSION;
      js = "// " + header + "\n" + js;
    }
    if (options.sourceMap) {
      answer = {
  ...
  if (require.extensions) {
    ...
    fn1 = function(ext) {
      ...
      return (base = require.extensions)[ext] != null ? base[ext] : base[ext] = function() {
        throw new Error("Use KavaScript.register() or require the kavascript/register module to require " + ext + " files.");
      };
    };
  ...
  exports._compileFile = function(filename, sourceMap) {
    ...
    try {
      answer = compile(stripped, {
        filename: filename,
        sourceMap: sourceMap,
        verbose: helpers.isVerbose(filename)
      });
    } catch (error) {
      err = error;
