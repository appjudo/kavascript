...
(function() {
  var KavaScript, addHistory, addMultilineHandler, fs, getCommandId, merge, nodeREPL, path, ref, replDefaults, runInContext, updateSyntaxError, vm;
  ...
  replDefaults = {
    prompt: 'kavascript> ',
    historyFile: process.env.HOME ? path.join(process.env.HOME, '.ks_history') : void 0,
  ...
  module.exports = {
    start: function(opts) {
      ...
      KavaScript.register();
      process.argv = ['ks'].concat(process.argv.slice(2));
